    ...
    <section className={`section ${styles.adminLogin}`}>
      <Container>
        ...
        <p className={styles.text}>
          ...
          особам вебсайту, якщо Ви не є такою особою, Ви маєте негайно залишити
          дану вебсторінку, інакше при неправильній авторизації доступ буде
          ...
          адмінській вебсторінці тільки українською мовою.
        </p>
        <form
